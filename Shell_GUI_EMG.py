...
btn2 = Button(window, text = 'Generate Output', command = dataproc)
btn2.pack(fill=X,padx = 100, pady = 50)

#
#
# lbl = Label(window, text = 'Hello', font = ('Arial',100))
