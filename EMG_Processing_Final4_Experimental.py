            ...
            # for a in range((len(peaks[t]))):
                ...
                # for c in range(len(freq[t])):
                    for c in range(len(freq)):
                        if abs(freq[c]) > 20 and lowflag == 0:
                    ...
                    spec_mom2 = 0
                    spec_mom5 = 0
                    # print('fp1: ' + str(fullpulse_lowfreqbound))
                    # print('fp2: ' + str(fullpulse_uppfreqbound))
                    ...
                    total_int = integrate.simps(power_spec[fullpulse_lowfreqbound:], freq[fullpulse_lowfreqbound:])
