...
# with open('C:/Users/sword/Anaconda3/envs/exceltest/NaEmAd/Adam_Biodex/Adam_Biodex_TR01.csv', 'r') as csvfile, open('C:/Users/sword/Anaconda3/envs/exceltest/NaEmAd/Adam_Biodex/Adam_Left_Arm_50_reps.csv', 'r') as torquefile:
# with open('C:/Users/sword/Anaconda3/envs/exceltest/NaEmAd/Adam_Biodex/Adam_Biodex_TR02.csv', 'r') as csvfile, open('C:/Users/sword/Anaconda3/envs/exceltest/NaEmAd/Adam_Biodex/Adam_Left_Arm_100_reps.csv', 'r') as torquefile:
# with open('C:/Users/sword/Anaconda3/envs/exceltest/NaEmAd/Adam_Biodex_Leg/Adam_Biodex_Leg01.csv', 'r') as csvfile, open('C:/Users/sword/Anaconda3/envs/exceltest/NaEmAd/Adam_Biodex_Leg/Adam_Right_Leg_100_reps.csv', 'r') as torquefile:
with open('C:/Users/sword/Anaconda3/envs/exceltest/NaEmAd/Adam_Biodex_Leg/Adam_Biodex_Leg02.csv', 'r') as csvfile, open('C:/Users/sword/Anaconda3/envs/exceltest/NaEmAd/Adam_Biodex_Leg/Adam_Right_Leg_50_reps.csv', 'r') as torquefile:

    csvreader = csv.reader(csvfile, delimiter=',')
    csvtorque = csv.reader(torquefile, delimiter=',')
    for row in csvreader:
        ...
        if csvreader.line_num >= 6:
            if row:
                ...
                break
    for row in csvtorque:
        if csvtorque.line_num == 1:
            temp2.append(row)
        if csvtorque.line_num >= 3:
            if row:
                temp2.append(row)
            else:
                break
...
df_torque = pd.DataFrame(temp2)
df_torque.columns = df_torque.iloc[0]
df_torque = df_torque.drop(0)
df_torque.reindex(df_torque.index.drop(1))
df_torque.reset_index(drop=True, inplace=True)
df_torque.columns = ['time','torque','position', 'relative_position', 'velocity']
df_torque = df_torque.astype(np.float)
for i in range(len(df_torque)):
    df_torque.time[i] = df_torque.time[i]/1000
...
ax0.plot(df_torque.time,df_torque.torque, color = 'red')
